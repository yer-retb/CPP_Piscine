...
/*   Updated: 2023/02/17 20:22:12 by yer-retb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string &target)
{
	...
	{
		this->energy_p -= 1;
		std::cout << this->Name << " attack " << target << ", causing " << this->attack_damege << " points of damage !" << std::endl;
	}
}
...
{
	this->hit_p -= amout;
	std::cout << this->Name << " take " << amout << " on the damage" << std::endl;
}
